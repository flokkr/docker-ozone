...
execute_robot_test ozone-om-0 /opt/smoketest/ozone-shell.robot "$RESULT_DIR/ozone-shell.xml"

execute_robot_test ozone-om-0 /opt/smoketest/awss3.robot "$RESULT_DIR/ozone-s3.xml"
